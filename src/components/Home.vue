    ...
    <div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand nav-logo " style="color: #7CC3CD;" href="#page-top">SugoiFit Financials</a>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-3 lh-1 mb-3">A central home for all your small business needs.</h1>
                ...
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-12 col-lg-5">
                        ...
                        <p class="lead fw-normal text-muted mb-5 mb-lg-0">
                            A new way of conducting business. No exerience with accounting? Not sure how to handle client orders? Not sure how to advertise products/services to customers?
                            No worries SugoiFit Financials aims to handle all these and more at just the click of a button. </p>
                    </div>
        ...
        <footer class="bg-black text-center py-5">
            <div class="container px-5">
                <div class="text-white-50 small">
                    <div class="mb-2">&copy; SugoiFit Financials 2021. All Rights Reserved.</div>
                    <a href="#!">Privacy</a>
